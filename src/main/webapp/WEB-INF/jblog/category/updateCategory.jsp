...
<table background="/images/kubrickbg.jpg" width="760" height="40" border="0" cellpadding="0" cellspacing="0">
	...
	<tr><td height="10">&nbsp;</td><td>
		...
		<table width="720" border="0" cellpadding="1" cellspacing="1">
			...
			<c:forEach var="category" items="${categoryList }" varStatus="status">
				<tr>
					...
					<c:if test="${category.categoryName != '미분류'}"><td align="center"><a href="/category/getCategoryList/${blog.blogId }/updateCategory/${category.categoryId }">${category.categoryName }</a></td></c:if>
        ...
        <!-- 카테고리 수정화면 시작 -->
        <form action="/category/${blog.blogId }/updateCategory/${category.categoryId }" method="post">
        <table width="720" border="0" cellpadding="1" cellspacing="1">
            <tr><td height="5">&nbsp;</td></tr>
            <tr><td height="5">&nbsp;</td></tr>
            ...
            <tr>
				...
				<td><input type="radio"	name="displayType" value="TITLE" <c:if test="${category.displayType == 'TITLE' }">checked</c:if>>제목&nbsp;&nbsp;
					<input type="radio" name="displayType" value="MIXED" <c:if test="${category.displayType == 'MIXED' }">checked</c:if>>제목 + 내용&nbsp;&nbsp;</td>
            </tr>
            <tr>
                <td width="150">설명 :</td>
